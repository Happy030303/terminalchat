...
//==========================================================================================================================
    ...
    private void sendOldMsgWhenUserWasOffline(String receiverName, IndividualUserHandler receiverHandlerObj)
    {
        ...
        catch (SQLException e){System.out.println("Error in sendOldMsgWhenUserWasOffline()");e.printStackTrace();}
    }
   ...
   @Override
    public void run()
    {
        try
        {
            ...
            // Send all old messages to this user immediately after login
            sendOldMsgWhenUserWasOffline(senderName, this);
